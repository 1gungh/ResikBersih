...
namespace RPGM.Gameplay
{
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        void MoveState()
        {
            ...
            UpdateAnimator(nextMoveCommand);
            rigidbody2D.linearVelocity = Vector2.SmoothDamp(rigidbody2D.linearVelocity, nextMoveCommand * speed, ref currentVelocity, acceleration, speed);
            spriteRenderer.flipX = rigidbody2D.linearVelocity.x >= 0 ? true : false;
        }
        ...
        void Awake()
        {
            ...
            pixelPerfectCamera = GameObject.FindFirstObjectByType<PixelPerfectCamera>();
        }
    }
}